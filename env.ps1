...
$env:CODEIAL_GOOGLE_CLIENT_URL="http://localhost:2000/users/auth/google/callback";
$env:CODEIAL_GMAIL_USERNAME="harshmittal7852";
$env:CODEIAL_GMAIL_PASSWORD="erharsh8492";
$env:CODEIAL_DB="codeial_development1";
